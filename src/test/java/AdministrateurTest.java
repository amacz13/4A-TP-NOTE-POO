...
import fr.amacz13.ensim.tpnote_poo.*;
import fr.amacz13.ensim.tpnote_poo.fr.amacz13.ensim.tpnote_poo.empruntable.*;
...
public class AdministrateurTest {
    ...
    public void setUp() throws Exception {
        ...
        //Changed to Imprimante (this is the only thing shared between agences and employees)
        e1 = new Imprimante(true);
        e2 = new Ecran();
        e3 = new Souris();
        e4 = new Clavier();
        e5 = new Clavier();
    ...
    public void supprimerMaterielDefectueuxAgence_sansMaterielDefectueux() {
        ...
        //Added Agence
        ((Administrateur) admin).supprimerMaterielDefectueuxAgence(a1);
